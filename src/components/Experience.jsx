...
const EXPERIENCES = [
  ...
  },
  {
    ...
    frameworks: ["Microsoft Azure Cloud", "PySpark","SQL Server Integration Services"],
  },
];
        ...
        {EXPERIENCES.map((experience, index) => (
          <div key={index} className="mb-8 flex items-start">
            <div className="w-1/3 pr-4 text-right">
              <p className="text-sm text-neutral-400 sticky top-0">
                {experience.year}
              </p>
            </div>
            ...
            <div className="w-2/3 pl-4">
              ...
              <ul className="list-disc pl-5">
                <li className="mb-4 text-neutral-600">{experience.description1}</li>
                <li className="mb-4 text-neutral-600">{experience.description2}</li>
              </ul>
              <div>
                {experience.frameworks.map((tech, index) => (
                  <span
                    key={index}
                    className="mr-2 mb-2 inline-block rounded px-2 py-1 text-sm bg-gray-100 text-gray-800"
                  >
                    {tech}
                  </span>
                ))}

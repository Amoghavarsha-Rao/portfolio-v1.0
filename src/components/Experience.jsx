...
const EXPERIENCES = [
  ...
  },
  {
    ...
    description2:
      "Participatedd in migrating SSIS Package to Azure Synapse as part of an agency-wide modernization initiative to achieve 100% functionality and reduce file drops and ensure smooth pipeline operations with a very low failure rate.",
    frameworks: [
